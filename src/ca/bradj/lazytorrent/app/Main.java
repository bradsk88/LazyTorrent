...
public class Main extends Application {
    ...
    private static final String CONFIG_FILE = getAppDataDir() + File.separator + getDotIfNeeded() + "LazyTorrent" + File.separator + "config";
    ...
    public void start(Stage stage) throws Exception {
        ...
        try {
            ...
            createTrayIcon(stage, ex);
            Parent pane = new LazyTorrentsControlPanel(m, LOGGER, rss, appConfig).getNode();
